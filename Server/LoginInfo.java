...
public class LoginInfo extends JFrame
{
	...
	//	jTable1.setModel(new DefaultTableModel(4, 4));
		...
		addComponent(contentPane, jLabel1, 100,36,361,40);
		addComponent(contentPane, jScrollPane1, 62,163,406,141);
		//
		// LoginInfo
		//
		this.setTitle("LoginInfo - extends JFrame");
		this.setLocation(new Point(99, 5));
		this.setSize(new Dimension(591, 431));
